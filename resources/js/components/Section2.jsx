        ...
        <div id='section2' className='text-center text-white'>
            ...
            <div className="container" id='image-area'>
                ...
                <div className='row mx-auto text-center justify-content-center'>
                    ...
                    <div className="image-pro col-lg-5 col-12 my-3"><img src={Calc} alt="" className="img-fluid" /></div>
                    <div className="image-pro col-lg-5 col-12 my-3"><img src={AlForqane} alt="" className="img-fluid" /></div>
                    ...
                    <div className="image-pro col-lg-3 col-12 my-3"><img src={Code_wizard} alt="" className="img-fluid" /></div>
